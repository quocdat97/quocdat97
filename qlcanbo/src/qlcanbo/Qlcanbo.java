...
public class Qlcanbo {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("\b\b\b\b Manager Officer");
            System.out.println("Enter 1: Insert officer");
            System.out.println("Enter 2: Search officer by name: ");
            System.out.println("Enter 3: Show information officers");
            System.out.println("Enter 4: Exit:");
            String line = scanner.nextLine();
            switch (line) {
                case "1": {
                    System.out.println("Enter a: Insert Enginner");
